...
/** This class is Following layout, which process the json file url and get variables
* from there
*/
public class Following extends Fragment{
    ...
    private String url = "https://api.github.com/user/following?access_token=7f00f23585937070a2a1bd91b6ad6f1a12132b10";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        lv = (ListView) myView.findViewById(R.id.list_following);
        new com.example.yaxin.webprofile.Following.GetFollowing().execute();
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    editor.putStringSet("following",following);
                    editor.commit();
